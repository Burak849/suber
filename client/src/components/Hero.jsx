...
export default function Hero() {
  return (
    ...
    <div
      className="bg-white"
      style={{
        backgroundImage: 'url("https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8dWJlciUyMGRyaXZlcnxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80")',
